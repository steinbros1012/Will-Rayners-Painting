      ...
      <section className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="bg-primary flex items-center px-8 lg:px-16 py-32 lg:py-0">
          <div className="max-w-xl">
            ...
            >
              Will Rayners Custom Painting brings careful prep, clean finishes, and five-star service to homes across Flowood and the Jackson metro.
            </motion.p>
            ...
            <div>
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { title: 'Local & reliable', desc: 'Based in Flowood, Will is accountable to the community he lives and works in.' },
